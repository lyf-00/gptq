...
CUDA_VISIBLE_DEVICES=0 python opt.py facebook/opt-350m c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-350m-w3-g128/qsd.pt >> Experiments/opt-350m-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=0 python opt.py facebook/opt-1.3b c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-1.3b-w2-g128/qsd.pt >> Experiments/opt-1.3b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=0 python llama.py ./llama2-hf/llama-2-7b c4     --wbits 4     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-7b-w4-g128/qsd.pt >> Experiments/llama-2-7b-w4-g128/log.txt
...
CUDA_VISIBLE_DEVICES=1 python opt.py facebook/opt-1.3b c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-1.3b-w3-g128/qsd.pt >> Experiments/opt-1.3b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=1 python opt.py facebook/opt-2.7b c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-2.7b-w2-g128/qsd.pt >> Experiments/opt-2.7b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=1 python llama.py ./llama2-hf/llama-2-13b c4     --wbits 4     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-13b-w4-g128/qsd.pt >> Experiments/llama-2-13b-w4-g128/log.txt
...
CUDA_VISIBLE_DEVICES=2 python opt.py facebook/opt-2.7b c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-2.7b-w3-g128/qsd.pt >> Experiments/opt-2.7b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=2 python opt.py facebook/opt-6.7b c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-6.7b-w2-g128/qsd.pt >> Experiments/opt-6.7b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=2 python llama.py ./llama2-hf/llama-2-7b c4     --wbits 3     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-7b-w3-g128/qsd.pt >> Experiments/llama-2-7b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=3 python opt.py facebook/opt-6.7b c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-6.7b-w3-g128/qsd.pt >> Experiments/opt-6.7b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=3 python opt.py facebook/opt-13b c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-13b-w2-g128/qsd.pt >> Experiments/opt-13b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=3 python llama.py ./llama2-hf/llama-2-13b c4     --wbits 3     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-13b-w3-g128/qsd.pt >> Experiments/llama-2-13b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=4 python opt.py facebook/opt-13b c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-13b-w3-g128/qsd.pt >> Experiments/opt-13b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=4 python opt.py facebook/opt-30b c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-30b-w2-g128/qsd.pt >> Experiments/opt-30b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=4 python llama.py ./llama2-hf/llama-2-7b c4     --wbits 2     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-7b-w2-g128/qsd.pt >> Experiments/llama-2-7b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=5 python opt.py facebook/opt-30b c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-30b-w3-g128/qsd.pt >> Experiments/opt-30b-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=5 python llama.py ./llama2-hf/llama-2-13b c4     --wbits 2     --groupsize 128     --true-sequential     --act-order     --save Experiments/llama-2-13b-w2-g128/qsd.pt >> Experiments/llama-2-13b-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=6 python opt.py facebook/opt-30b c4     --wbits 4     --groupsize 128    --act-order     --save Experiments/opt-30b-w4-g128/qsd.pt >> Experiments/opt-30b-w4-g128/log.txt
...
CUDA_VISIBLE_DEVICES=6 python opt.py facebook/opt-125m c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-125m-w2-g128/qsd.pt >> Experiments/opt-125m-w2-g128/log.txt
...
CUDA_VISIBLE_DEVICES=7 python opt.py facebook/opt-125m c4     --wbits 3     --groupsize 128    --act-order     --save Experiments/opt-125m-w3-g128/qsd.pt >> Experiments/opt-125m-w3-g128/log.txt
...
CUDA_VISIBLE_DEVICES=7 python opt.py facebook/opt-350m c4     --wbits 2     --groupsize 128    --act-order     --save Experiments/opt-350m-w2-g128/qsd.pt >> Experiments/opt-350m-w2-g128/log.txt
...
python eval-nlp/convert_llama_weights_to_hf.py  --input_dir ~/yangwang/elasticedge1/yangwang5/llama-2/ --model_size 7B --output_dir ./llama2-hf
python eval-nlp/convert_llama_weights_to_hf.py  --input_dir ~/yangwang/elasticedge1/yangwang5/llama-2/ --model_size 13B --output_dir ./llama2-hf